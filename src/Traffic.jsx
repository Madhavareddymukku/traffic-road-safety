...
const Traffic = () => {
  ...
  const proceedSound = require("./Green.mp3");pm run startLightChange
  ...
  return (
    <div className="bg-green-200 md:h-full h-lvh">
      {!buttonClicked ? (
        <>
          <Header />
          <button
        ...
        <>
          ...
          <div className="flex justify-center">
            ...
            <button
              onClick={() => playAudio(activeLight)}
              className="bg-red-400 mx-4 my-2 px-4 py-2 text-white rounded-md"
            >
              Walk
            </button>
          </div>
          <button
            className="p-4 m-4 bg-red-400 rounded-md text-white"
            allow="autoplay;"
            onClick={handleButtonClick}
          >
            Don't walk
